export function RateDots({ score, max = 5, justify = "center" }: { score: number; max?: number; justify?: "center" | "flex-start" }) {
  return (
    <div style={{ display: "flex", justifyContent: justify, gap: 5 }}>
